...
if (salarioDescontoINSS > 4664.68) {
    salaroLiquido = salarioDescontoINSS - (salarioDescontoINSS * 0.275)
}
else if (salarioDescontoINSS <=4664.68 && salarioDescontoINSS >= 3751.06) {
    salaroLiquido = salarioDescontoINSS - (salarioDescontoINSS* 0.225)
}
else if (salarioDescontoINSS <=3751.05 && salarioDescontoINSS >= 2826.66) {
    salaroLiquido = salarioDescontoINSS - (salarioDescontoINSS* 0.15)
}
else if (salarioDescontoINSS <=2826.65 && salarioDescontoINSS >= 1903.99) {
    salaroLiquido = salarioDescontoINSS - (salarioDescontoINSS* 0.075)
}
else {
    salaroLiquido = salarioDescontoINSS
}
console.log (salaroLiquido)